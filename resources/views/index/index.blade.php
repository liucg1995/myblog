...
<head>
    ...
    script
    src = "{{asset("
    templates / blog / js / html5shiv.min.js
    ")}}"
    ...
    script
    src = "{{asset("
    templates / blog / js / selectivizr - min.js
    ")}}"
    type = "text/javascript" ></script>
    <![endif]-->
    <!--[if lt IE 9]>
            ...
            <div class="navbar-header">
                ...
                <h1 class="logo hvr-bounce-in"><a href="index.htm" tppabs="" title="木庄网络博客">
                        <img src="upload/201610/17/201610171329086541.png"
                             tppabs="upload/201610/17/201610171329086541.png" alt="木庄网络博客"/></a></h1>
            </div>
            <div class="collapse navbar-collapse" id="header-navbar" name="index">
                <form class="navbar-form visible-xs">
                    <div class="input-group">
                        <input type="text" class="form-control"
                               onkeydown="if (event.keyCode == 13) {SiteSearch('search.html', '#keyword');return false};"
        ...
        <div class="widget widget_sentence">
            ...
            <div class="widget-sentence-content">
                ...
                <a href="javascript:if(confirm('http://web.muzhuangnet.com/  \n\n??ļ????? Teleport Ultra ??, ?Ϊ ??һ???????????????Ϊ?????????ĵ????  \n\n????????????'))window.location='http://web.muzhuangnet.com/'"
                   tppabs="http://web.muzhuangnet.com/" title="网站建设" target="_blank">网站建设</a>&nbsp;&nbsp;&nbsp;

                <a href="javascript:if(confirm('http://jitaoblog.com/  \n\n??ļ????? Teleport Ultra ??, ?Ϊ ??һ???????????????Ϊ?????????ĵ????  \n\n????????????'))window.location='http://jitaoblog.com/'"
                   tppabs="http://jitaoblog.com/" title="纪涛博客" target="_blank">纪涛博客</a>&nbsp;&nbsp;&nbsp;

                <a href="javascript:if(confirm('http://www.d9y.net/  \n\n??ļ????? Teleport Ultra ??, ?Ϊ ??һ???????????????Ϊ?????????ĵ????  \n\n????????????'))window.location='http://www.d9y.net/'"
                   tppabs="http://www.d9y.net/" title="第9页" target="_blank">第9页</a>&nbsp;&nbsp;&nbsp;

                <a href="javascript:if(confirm('http://tianzqn.com/  \n\n??ļ????? Teleport Ultra ??, ?Ϊ ??һ???????????????Ϊ?????????ĵ????  \n\n????????????'))window.location='http://tianzqn.com/'"
                   tppabs="http://tianzqn.com/" title="天中青年" target="_blank">天中青年</a>&nbsp;&nbsp;&nbsp;

                <a href="javascript:if(confirm('http://www.liuhaihua.cn/  \n\n??ļ????? Teleport Ultra ??, ?Ϊ ??һ???????????????Ϊ?????????ĵ????  \n\n????????????'))window.location='http://www.liuhaihua.cn/'"
                   tppabs="http://www.liuhaihua.cn/" title="Harries BLOG" target="_blank">Harries BLOG</a>&nbsp;&nbsp;&nbsp;
